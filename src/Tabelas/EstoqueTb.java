 ...
 * @author Aluno
 */
public class EstoqueTb extends javax.swing.JFrame {

    /**
     * Creates new form EstoqueTb
     */
    public EstoqueTb() {
        initComponents();
        preencherJTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstoqueTb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
